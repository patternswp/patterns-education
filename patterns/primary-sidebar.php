 ...
 * Slug: patterns-education/primary-sidebar
 * Categories: posts
...
<div class="wp-block-group">
    <!-- wp:pattern {"slug":"patterns-education/search-form"} /-->
    <!-- wp:pattern {"slug":"patterns-education/latest-posts"} /-->
    <!-- wp:pattern {"slug":"patterns-education/latest-comments"} /-->
</div>
<!-- /wp:group -->